...
import edu.cornell.pserc.jpower.tdouble.jpc.DZjp_areas;
import edu.cornell.pserc.jpower.tdouble.jpc.DZjp_branch;
...
public class DZjp_ext2int {
	 ...
	 * @return
	 */
	public static Object[] jp_ext2int(DZjp_bus bus, DZjp_gen gen, DZjp_branch branch) {
