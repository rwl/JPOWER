...
public class Djp_case300 {

	public static JPC t_case300() {
		...
		/* branch data */
		jpc.branch = branch();  // avoid byte limit for method
	...
	private static Branch branch() {
		...
		return Branch.fromMatrix( DoubleFactory2D.dense.make(new double[][] {
	...
	private static GenCost genCost() {
		//	1	startup	shutdow	n	x1	y1	...	xn	yn
		//	2	startup	shutdow	n	c(n-1)	...	c0
		return GenCost.fromMatrix( DoubleFactory2D.dense.make(new double[][] {
			{2,	0,	0,	3,	0.01,	40,	0},
			{2,	0,	0,	3,	0.01,	40,	0},
			{2,	0,	0,	3,	0.01,	40,	0},
			{2,	0,	0,	3,	0.01,	40,	0},
